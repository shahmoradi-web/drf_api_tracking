...
urlpatterns = [
    ...
    path(r"^custom-check-logging/", test_views.MockCustomCheckLoggingView.as_view()),
    path("sensitive-fields-logging/", test_views.MockSensitiveFieldsLoggingView.as_view()),
    path(r"^invalid-cleaned-substitute-logging/", test_views.MockInvalidCleanedSubstituteLoggingView.as_view()),
    path(
        "custom-check-logging-methods-fail/", test_views.MockCustomCheckLoggingWithLoggingMethodsFailView.as_view()
    ),
]